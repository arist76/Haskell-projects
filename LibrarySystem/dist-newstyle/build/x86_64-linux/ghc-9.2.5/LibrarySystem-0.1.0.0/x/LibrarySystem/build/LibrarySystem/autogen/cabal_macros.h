...
/* package LibrarySystem-0.1.0.0 */
#ifndef VERSION_LibrarySystem
#define VERSION_LibrarySystem "0.1.0.0"
#endif /* VERSION_LibrarySystem */
#ifndef MIN_VERSION_LibrarySystem
#define MIN_VERSION_LibrarySystem(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_LibrarySystem */
...
#define CURRENT_COMPONENT_ID "LibrarySystem-0.1.0.0-inplace-LibrarySystem"
